 ...
 */
public class RouterSynchronousDispatcher implements Dispatcher {
  ...
  public RouterSynchronousDispatcher(ResteasyProviderFactory providerFactory) {
  ...
  public RouterSynchronousDispatcher(ResteasyProviderFactory providerFactory, ResourceMethodRegistry registry) {
  ...
  public void invokePropagateNotFound(HttpRequest request, HttpResponse response) throws javax.ws.rs.NotFoundException {
    try {
      ...
      try {
        ...
        if (failure instanceof javax.ws.rs.NotFoundException) {
          throw ((javax.ws.rs.NotFoundException) failure);
        } else {
  ...
  public ResourceInvoker getInvoker(HttpRequest request)
    ...
    if (invoker == null) {
      throw new javax.ws.rs.NotFoundException(Messages.MESSAGES.unableToFindJaxRsResource(request.getUri().getPath()));
    }
    return invoker;
  }
